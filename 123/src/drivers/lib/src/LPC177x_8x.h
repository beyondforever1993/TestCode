...
typedef struct
{
  ...
  __IO uint32_t PC;                     /*!< Offset: 0x010 Prescale Counter Register (R/W) */
  __IO uint32_t MCR;                    /*!< Offset: 0x014 Match Control Register (R/W) */
  __IO uint32_t MRL[4];                    /*!< Offset: 0x018 Match Register 0-3 (R/W) */
  __IO uint32_t CCR;                    /*!< Offset: 0x028 Capture Control Register (R/W) */
  __I  uint32_t CR[4];                    /*!< Offset: 0x02C Capture Register 0-3 (R/ ) */
       uint32_t RESERVED0;
  __IO uint32_t MRH[3];                    /*!< Offset: 0x018 Match Register 4-6 (R/W) */
...
#define LPC_SPI_BASE          (LPC_AHB_BASE  + 0x14000)
