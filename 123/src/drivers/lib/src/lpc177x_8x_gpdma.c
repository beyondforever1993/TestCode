...
volatile const void *GPDMA_LUTPerAddr[] = {
        ...
        (&LPC_TIM0->MR[0]),                // MAT0.0
        (&LPC_TIM0->MR[1]),                // MAT0.1
        (&LPC_TIM1->MR[0]),                // MAT1.0
        (&LPC_TIM1->MR[1]),                // MAT1.1
        (&LPC_TIM2->MR[0]),                // MAT2.0
        (&LPC_TIM2->MR[1]),                // MAT2.1
        ...
        (&LPC_TIM3->MR[0]),                // MAT3.0
        (&LPC_TIM3->MR[1]),                // MAT3.1
};
