 ...
 *
 **********************************************************************/
IAP_STATUS_CODE CopyRAM2Flash(uint8_t * dest, uint8_t const * const source, IAP_WRITE_SIZE size)
{
    uint32_t sec;
 ...
 *
 **********************************************************************/
IAP_STATUS_CODE Compare(uint8_t *addr1, const uint8_t *const addr2, uint32_t size)
{
   IAP_COMMAND_Type command;
