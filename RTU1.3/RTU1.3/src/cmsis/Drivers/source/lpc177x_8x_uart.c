...
static Status uart4_set_divisors(LPC_UART4_TypeDef *UARTx, uint32_t baudrate);
 ...
 * @return 		None
 *********************************************************************/
void UART4_Init(LPC_UART4_TypeDef *UARTx, UART_CFG_Type *UART_ConfigStruct)
{
	uint32_t tmp;
	...
	uart4_set_divisors(UARTx, (UART_ConfigStruct->Baud_rate));
 ...
 * @return 		None
 *********************************************************************/
void UART4_IntConfig(LPC_UART4_TypeDef *UARTx, UART_INT_Type UARTIntCfg, FunctionalState NewState)
{
	uint32_t tmp;
 ...
 * @return none
 **********************************************************************/
void UART4_TxCmd(LPC_UART4_TypeDef *UARTx, FunctionalState NewState)
{
	if (NewState == ENABLE)
	{
		if (((LPC_UART1_TypeDef *)UARTx) == LPC_UART1)
